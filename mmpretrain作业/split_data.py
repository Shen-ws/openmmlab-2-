...
def copy_dataset(src_img_list, data_index, target_path):
    ...
    for index in data_index :
        ...
        all_class_name = os.path.split(src_img)[0]
        class_name = os.path.split(all_class_name)[-1]
        shutil.copy(src_img, target_path)
        name = os.path.join(class_name ,img_name)

        target_img_list.append(name)
